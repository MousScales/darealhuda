...
export default function FullOnboardingScreen({ route, navigation, onComplete }) {
  ...
  const getSteps = (language) => [
    ...
    },
    {
      ...
      field: 'language',
      options: [
        { id: 'english', name: t('english', language), icon: '🇺🇸', description: t('english', language) },
        { id: 'french', name: t('french', language), icon: '🇫🇷', description: t('french', language) },
        { id: 'italian', name: t('italian', language), icon: '🇮🇹', description: t('italian', language) },
        { id: 'spanish', name: t('spanish', language), icon: '🇪🇸', description: t('spanish', language) }
      ]
    },
    {
      id: 'firstName',
...

    {
      ...
      options: [
        { id: 'new', name: t('newMuslim', language), icon: '🆕', description: t('recentlyRevertedToIslam', language) },
        { id: 'beginner', name: t('beginner', language), icon: '🌱', description: t('learningTheBasics', language) },
        { id: 'intermediate', name: t('intermediate', language), icon: '📚', description: t('beenPracticingForAWhile', language) },
        { id: 'advanced', name: t('advanced', language), icon: '🌟', description: t('experiencedPractitioner', language) }
      ]
    },
    // {
    //   id: 'subscription',
    //   title: 'Subscribe to Continue',
    //   subtitle: 'A subscription is required to use Hudā. You will be charged $9.99/month to access all features.',
    //   type: 'subscription'
    // },
    {
      id: 'completion',
  ...
  const handleComplete = async () => {
    ...
    console.log('🎯 userData.experienceLevel:', userData.experienceLevel);
